"""
Django settings for routers_management project.
...
SECRET_KEY = 'azg88v%36ytieh!2o_%t%q1i)%nt6wmb73*dpf@wlog(46+3md'
...
WSGI_APPLICATION = 'routers_management.wsgi.application'
